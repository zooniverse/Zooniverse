...
(function() {
  ...
  LanguagesMenu = (function(_super) {
    ...
    function LanguagesMenu() {
      ...
      var _ref8, _ref9,
        _this = this;
      this.availableLanguages = (_ref8 = LanguageManager.current) != null ? _ref8.getAvailableLanguages() : void 0;
      this.preferredLanguage = (_ref9 = LanguageManager.current) != null ? _ref9.getPreferredLanguage() : void 0;
      LanguagesMenu.__super__.constructor.apply(this, arguments);
      LanguageManager.on('language-fetched', function(e, languageCode) {
        return _this.setLanguageButton(languageCode);
      });
    }
    ...
    LanguagesMenu.prototype.onClickLanguageButton = function(e) {
      ...
      return (_ref8 = LanguageManager.current) != null ? _ref8.setLanguage(target.val(), function() {
        return _this.setLanguageButton(target.val());
      }) : void 0;
    };

    LanguagesMenu.prototype.setLanguageButton = function(languageCode) {
      var buttons, target;
      target = this.el.find('button[value="' + languageCode + '"]');
      if (target.length) {
