module.exports = function(__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push(I18n.t('zooniverse.sign_up.email'));
    
      __out.push('</span> <input type="text" name="email" required="required" /></label>\n  <label><span>');
    
      __out.push(I18n.t('zooniverse.login.password'));
    
      __out.push('</span> <input type="password" name="password" required="required" /></label>\n  <label><span>');
    
      __out.push(I18n.t('zooniverse.sign_up.confirmation'));
    
      __out.push('</span> <input type="password" name="password-confirm" required="required" /></label>\n  <label class="privacy-policy"><input type="checkbox" name="policy" required="required" /> ');
    
      __out.push(I18n.t('zooniverse.sign_up.privacy'));
