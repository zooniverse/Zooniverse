...
(function() {
  ...
  Subject = (function(_super) {
    ...
    Subject.baseUrl = function() {
      if (this.prototype.projectName) {
        return "/projects/" + this.prototype.projectName;
      } else {
        return '';
      }
    };
    ...
    Subject.all = function() {
      return this.findAllByAttribute('projectName', this.prototype.projectName);
    };
