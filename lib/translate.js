...
(function() {
  var LanguageManager, translate, _ref, _ref1, _ref10, _ref11, _ref12, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    __slice = [].slice;
  ...
  translate.refresh = function(element, key) {
    var name, property, string, value, _i, _len, _ref13, _ref14, _ref15, _ref16, _ref17, _results;
    _ref13 = element.attributes;
    _results = [];
    for (_i = 0, _len = _ref13.length; _i < _len; _i++) {
      _ref14 = _ref13[_i], name = _ref14.name, value = _ref14.value;
      ...
      string = (_ref15 = translate.strings[(_ref16 = LanguageManager.current) != null ? _ref16.code : void 0]) != null ? _ref15[value] : void 0;
      string || (string = (_ref17 = translate.strings[LanguageManager.prototype.code]) != null ? _ref17[value] : void 0);
      string || (string = value);
  ...
  LanguageManager.on('change-language', function() {
    var element, _i, _len, _ref13, _results;
    _ref13 = document.querySelectorAll("[" + translate.attr + "]");
    _results = [];
    for (_i = 0, _len = _ref13.length; _i < _len; _i++) {
      element = _ref13[_i];
