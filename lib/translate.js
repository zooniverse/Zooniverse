...
(function() {
  var LanguageManager, translate, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    __slice = [].slice;
  ...
  translate.strings = {
    ...
    cs: ((_ref15 = window.zooniverse) != null ? (_ref16 = _ref15.translations) != null ? _ref16.cs : void 0 : void 0) || require('../translations/cs')
  };

  translate.refresh = function(element, key) {
    var name, property, string, value, _i, _len, _ref17, _ref18, _ref19, _ref20, _ref21, _results;
    _ref17 = element.attributes;
    _results = [];
    for (_i = 0, _len = _ref17.length; _i < _len; _i++) {
      _ref18 = _ref17[_i], name = _ref18.name, value = _ref18.value;
      ...
      string = (_ref19 = translate.strings[(_ref20 = LanguageManager.current) != null ? _ref20.code : void 0]) != null ? _ref19[value] : void 0;
      string || (string = (_ref21 = translate.strings[LanguageManager.prototype.code]) != null ? _ref21[value] : void 0);
      string || (string = value);
  ...
  LanguageManager.on('change-language', function() {
    var element, _i, _len, _ref17, _results;
    _ref17 = document.querySelectorAll("[" + translate.attr + "]");
    _results = [];
    for (_i = 0, _len = _ref17.length; _i < _len; _i++) {
      element = _ref17[_i];
