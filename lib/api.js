...
(function() {
  ...
  Api = {
    ...
    requestJquery: function(type, url, data, done, fail) {
    ...
    request: function(type, url, data, done, fail) {
      if (window.location.protocol === "file:") {
        return Api.requestJquery(type, url, data, done, fail);
      } else {
        return Api.requestProxy(type, url, data, done, fail);
      }
    },
    requestProxy: function(type, url, data, done, fail) {
      var id, message;
      id = Api.nextId();
      if (typeof data === 'function') {
        fail = done;
