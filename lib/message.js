  ...
  Message = (function() {
    ...
    Message.prototype.send = function() {
      ...
      if (Api.checkMobile() === false) {
        ...
        this.payload.url = "" + Api.host + "/" + this.payload.url;
        if (this.payload.type === "getJSON") {
          this.payload.url = "" + this.payload.url + "?callback=?";
          this.payload.type = 'get';
          this.payload.dataType = 'json';
        }
        this.payload.success = this.succeed;
        this.payload.error = this.fail;
        this.payload.complete = this.always;
        $.ajax(this.payload);
      }
      return this;
    };
