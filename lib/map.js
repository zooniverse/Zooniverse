...
(function() {
  ...
  Map = (function() {
    ...
    function Map(params) {
      var param, url, value, _ref, _ref1, _ref2, _ref3,
        _this = this;
      if (params == null) {
        params = {};
      }
      ...
      $(window).on('hashchange', function() {
        var x, y, _ref4;
        _ref4 = _this.map.getSize(), x = _ref4.x, y = _ref4.y;
        if (0 === x || 0 === y) {
    ...
    Map.prototype.setCenter = function(lat, lng) {
      ...
      return this.map.setView(new Leaflet.LatLng(lat + shift.lat, lng + shift.lng), this.map.getZoom());
    };
