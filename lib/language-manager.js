...
(function() {
  var $, Api, DEFAULT_LANGUAGE_CODE, EventEmitter, HTML, LanguageManager, languageStringsKey, preferredLanguageKey, _base, _ref, _ref1,
  ...
  preferredLanguageKey = Api.current != null ? "" + Api.current.project + "-preferredLanguage" : "preferredLanguage";

  languageStringsKey = Api.current != null ? "" + Api.current.project + "-languageStrings" : "languageStrings";
  ...
  LanguageManager = (function(_super) {
    ...
    function LanguageManager() {
      ...
      if (!(this.preferredLanguage = ((function() {
        ...
        if (localStorage[preferredLanguageKey] != null) {
          this.preferredLanguage || (this.preferredLanguage = localStorage[preferredLanguageKey]);
        }
    ...
    LanguageManager.prototype.setLanguage = function(languageCode, callback) {
      ...
      request.done(function(data) {
        ...
        localStorage[preferredLanguageKey] = _this.preferredLanguage;
