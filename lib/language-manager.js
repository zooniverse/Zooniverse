...
(function() {
  var $, Api, DEFAULT_LANGUAGE_CODE, EventEmitter, HTML, LanguageManager, _base, _ref, _ref1,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  Api = ((_ref = window.zooniverse) != null ? _ref.Api : void 0) || require('./api');

  EventEmitter = ((_ref1 = window.zooniverse) != null ? _ref1.EventEmitter : void 0) || require('./event-emitter');
  ...
  LanguageManager = (function(_super) {
    ...
    function LanguageManager() {
      ...
      this.preferredLanguageKey = Api.current != null ? "" + Api.current.project + "-preferredLanguage" : "preferredLanguage";
      this.languageStringsKey = Api.current != null ? "" + Api.current.project + "-languageStrings" : "languageStrings";
      if (!(this.preferredLanguage = ((function() {
        try {
          return location.search.match(/lang=([\$|\w]+)/)[1];
        } catch (_error) {}
      })()))) {
        if (localStorage[this.preferredLanguageKey] != null) {
          this.preferredLanguage || (this.preferredLanguage = localStorage[this.preferredLanguageKey]);
        }
    ...
    LanguageManager.prototype.setLanguage = function(languageCode, callback) {
      ...
      request.done(function(data) {
        ...
        localStorage[_this.preferredLanguageKey] = _this.preferredLanguage;
        localStorage[_this.languageStringsKey] = JSON.stringify(data);
