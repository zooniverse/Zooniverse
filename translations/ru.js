...
(function() {
  ...
  ru = {
    ...
    betaPreference: 'Я хочу получать уведомления о возможностях опробовать и написать отзыв о проектах Zooniverse, которые готовятся к выходу.',
    ...
    footerHeading: 'Zooniverse — это группа веб-проектов гражданской науки, которые привлекают усилия добровольцев, чтобы помочь исследователям совладать с противостоящими им огромными объемами данных.',
    privacyPolicy: 'Политика конфиденциальности',
    forkOnGitHub: 'Исходный код и баги',
    recents: 'Недавние события',
    favorites: 'Избранное',
    none: 'пусто'
  };
